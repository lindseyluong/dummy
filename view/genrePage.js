    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
      <View style={{ flex: 1, justifyContent: 'space-between' }}>
        <View style={{ marginTop: 10 }}>
          ...
          <Text style={{ fontSize: 25, fontWeight: 'bold', fontFamily: 'GeezaPro-Bold', color: 'black', marginTop: 15, left: 20 }}>
            Select two or more genres
          </Text>
        </View>
        <View>
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center' }}>
            {genres.map((genre, index) => (
              <TouchableOpacity
                ...
                style={[
                  { width: 100, height: 100, borderRadius: 50, backgroundColor: '#DDDDDD', justifyContent: 'center', alignItems: 'center', margin: 10 },
                  selectedGenres.includes(genre) && { backgroundColor: '#088335' }
                ]}
                onPress={() => handleGenreSelect(genre)}
              >
                <Text style={{ fontSize: 16, fontWeight: 'bold', color: selectedGenres.includes(genre) ? '#fff' : '#088335' }}>{genre}</Text>
              </TouchableOpacity>
            ))}
          </View>
        </View>
